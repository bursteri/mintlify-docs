...
description: "Complete Signal activation with an identity-free server verification event and confirm that PlainRouter accepts the tracker-scoped request."
---
