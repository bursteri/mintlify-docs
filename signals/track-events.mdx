...
While consent is pending or denied, PlainRouter records anonymous events without visitor IDs, user data, click IDs, or URL query strings. Those events are not sent to connected advertising destinations.
