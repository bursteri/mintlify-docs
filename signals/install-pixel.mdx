...
description: "Add optional, consent-aware browser measurement to your website."
---
...
<Steps>
  ...
  <Step title="Deploy and visit your site">
    ...
    After your consent integration supplies `granted`, track a test event and use the network checks below to confirm the pixel loads and sends it.
  </Step>
</Steps>
...
`signalq("init", ...)` initializes browser collection. Browser events require `consent_basis: consent` and granted terminal-storage, advertising-user-data, and advertising-personalization state. While consent is pending or denied, browser measurement events are not accepted.
