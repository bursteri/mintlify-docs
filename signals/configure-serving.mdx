...
The overlap ends when PlainRouter observes the first authenticated arrival using the new secret or when you click **Confirm new secret installed**. Keep the old deployment available until one of those conditions is met.
