...
| Operation | Reference |
| --- | --- |
| Discover the request contract | [GET sandbox](https://plainrouter.com/docs/api-reference/sandbox/discover-the-zero-auth-sandbox) |
| Issue a key with GET | [GET sandbox key](https://plainrouter.com/docs/api-reference/sandbox/get-a-sandbox-api-key) |
| Issue a key with POST | [POST sandbox key](https://plainrouter.com/docs/api-reference/sandbox/create-a-sandbox-api-key) |
| Validate without a key | [Synthetic event](https://plainrouter.com/docs/api-reference/sandbox/validate-a-synthetic-event) |
| Validate bearer authentication | [Keyed synthetic event](https://plainrouter.com/docs/api-reference/sandbox/validate-a-synthetic-event-with-a-sandbox-key) |
...
Registration is self-serve. Review the current EUR pricing bands, included arrivals, and overage rules in [Pricing and billing](/billing/overview). The workspace owner can issue scoped [workspace execution tokens](/actions/workspace-tokens) from the dashboard.
