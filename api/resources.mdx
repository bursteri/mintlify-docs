...
- Use the [RFC 9727 API catalog](/api/catalog) when software needs
  typed link relations.
- Use the [signed OpenAPI specification](/api/conversions#use-the-signed-openapi-contract)
  when software needs operation and schema details.
- Use [Authentication and clients](/api/authentication) before sending a
  credential.
