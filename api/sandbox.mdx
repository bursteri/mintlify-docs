...
Registration is self-serve. Review the current EUR spend bands and free arrival counting in [Pricing and billing](/billing/overview). A current workspace owner or team member can issue role-capped [workspace execution tokens](/mcp/workspace-tokens) from the dashboard.
