...
[`github.com/plainrouter/sdk-go`](https://pkg.go.dev/github.com/plainrouter/sdk-go) is the official Go SDK generated from PlainRouter's signed OpenAPI contract. Release `v0.5.0` targets signed API contract `0.5.0`.
