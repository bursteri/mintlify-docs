...
For a request that writes data, follow the [event example and destination test sequence](/sdk/cli/commands).
...
See the [CLI command reference](/sdk/cli/commands) for every supported operation.
