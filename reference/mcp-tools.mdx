---
title: "PlainRouter MCP server tools"
description: "Reference for the 12 account-scoped tools exposed by the PlainRouter MCP server."
---

PlainRouter MCP server version `0.3.0` exposes exactly 12 tools. All use the advertising account selected during workspace-token issuance.
