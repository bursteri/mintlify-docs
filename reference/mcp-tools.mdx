---
title: "MCP tools"
description: "Reference for the eight account-scoped tools exposed by the PlainRouter MCP server."
---

PlainRouter MCP server version `0.3.0` exposes exactly eight tools. All use the advertising account selected by the person during OAuth authorization or workspace-token issuance.
