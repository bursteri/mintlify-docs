...
| SDK | You want generated types and methods in application code. |
| CLI | You want to test an operation or run an operational script from a terminal. |
| OpenAPI contract | You want to inspect the complete schema or generate another compatible client. |

SDK and CLI distributions can use platform-specific package names and flags. Confirm that your client targets PlainRouter API contract `0.2.0`, then use its built-in help for installation-specific syntax.
