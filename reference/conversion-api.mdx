...
The `@plainrouter/sdk` and `@plainrouter/cli` packages target PlainRouter API contract `0.2.0`. They remain `0.x` interfaces until PlainRouter publishes a stable release.
