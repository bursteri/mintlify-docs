...
The signed REST contract, TypeScript SDK, Python SDK, Go SDK, and CLI are published at version `0.5.0`. Ruby SDK `0.1.0` targets the same signed API contract `0.5.0`. See [Client releases](#client-releases) for package links and the CLI's command boundary.
