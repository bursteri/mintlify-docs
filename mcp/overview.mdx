...
A workspace owner creates a key under **Settings → Workspace keys**. Start with the **Read** tier for account and creative-library inspection; proposal-producing tools require **Write**. [Choose a token tier](/mcp/workspace-tokens#access-tiers).
