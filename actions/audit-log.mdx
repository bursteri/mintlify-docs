---
title: "Audit log"
description: "Trace proposals, provider execution, verification, and restoration in the versioned audit chain."
---

Open **Audit log** from the PlainRouter sidebar to review the chronological Actions history for the current workspace.
...
<Steps>
  ...
  <Step title="Revoke access if necessary">
    Revoke the PlainRouter agent connection. Revocation disables its principal and OAuth tokens.
  </Step>
</Steps>
