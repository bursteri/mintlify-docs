...
<Steps>
  <Step title="A person authorizes one account">
    During MCP authorization, you choose the exact Meta ad account and permissions the agent may use. You can authorize with OAuth or an owner-issued workspace token. The agent cannot replace that account ID in a tool call.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Connect an agent" icon="bot" href="/actions/connect-agent">
    Authorize an MCP client with OAuth or a workspace token for one advertising account.
  </Card>
