...
description: "Test PlainRouter MCP without credentials, then connect production with an account-bound workspace execution token."
---

PlainRouter exposes two remote Model Context Protocol endpoints:
...
Point the client at `https://plainrouter.com/mcp/sandbox`. No PlainRouter account,
credential, or human approval is required.
