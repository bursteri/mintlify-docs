...
PlainRouter CLI `0.2.0` wraps the nine operations from API contract `0.2.0`. The current signed REST contract is `0.3.1` and also includes ingestion verification, which is not yet a CLI command.
