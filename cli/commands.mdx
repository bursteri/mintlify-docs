...
The `plainrouter` command wraps all nine operations in the signed Conversion API contract.
...
```bash
plainrouter events create --data '{"event_name":"Purchase","event_id":"order-123"}'
