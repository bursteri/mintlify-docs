...
PlainRouter CLI `0.3.1` exposes nine commands backed by `@plainrouter/sdk` `0.3.1`. The signed API contract also includes ingestion verification, which is available through the SDKs, direct REST, or MCP rather than a CLI command.
