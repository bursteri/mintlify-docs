...
**Improved** · Activity totals now include valid passive arrivals without exposing them in event-level lists or detail APIs. Invalid traffic stays out of the totals, and strict-EU aggregate cells remain hidden until they contain at least five arrivals. [Interpret Signal activity](/signals/health-and-performance#events-received).
