...
<Update label="August 27, 2026">
  ...
  ## Official Ruby SDK is available on RubyGems

  **New** · [`plainrouter-sdk 0.1.0`](https://rubygems.org/gems/plainrouter-sdk) brings the signed Conversion API contract `0.5.0` to Ruby 3.2 and newer. Install it with `gem install plainrouter-sdk -v 0.1.0`, then use the compact events, operations, and zero-auth sandbox client groups. [Install the Ruby SDK](/sdk/ruby).
</Update>
